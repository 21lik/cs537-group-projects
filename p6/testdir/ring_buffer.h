...
struct __attribute__((packed, aligned(64))) ring {
	...
	pthread_mutex_t p_mutex;  // Mutex for producer operations
	pthread_mutex_t c_mutex;  // Mutex for consumer operations
	pthread_cond_t not_full;  // Condition variable to wait/signal when not full
	pthread_cond_t not_empty; // Condition variable to wait/signal when not empty
